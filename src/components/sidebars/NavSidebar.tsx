...
function NavSidebar() {
  ...
  return (
    <div
    className={`fixed z-50 top-0 left-0 h-screen w-screen bg-black-2 bg-gray-800 text-white transform transition-transform duration-300 ease-in-out ${
        isSideMenuOpen ? 'translate-x-0 opacity-100' : 'translate-x-full '
    }`}
  >
    {/* links */}
